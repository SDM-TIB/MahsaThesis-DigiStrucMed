# NeSyCoT — Not All Knowledge Graphs Help LLMs Equally: Rule-Guided Traversal for Chain-of-Thought Fine-Tuning
...
java -jar amie3.5.1.jar -const KG\qKG\qKG.nt > amie_output_qKG.txt

### 1. Install dependencies

```bash
pip install bitsandbytes transformers peft accelerate datasets sentencepiece scikit-learn torch trl matplotlib pandas
```
